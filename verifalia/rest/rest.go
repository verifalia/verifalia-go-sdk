...
var BaseUrls = []string{
	"https://api-1.verifalia.com/v2.3",
	"https://api-2.verifalia.com/v2.3",
	"https://api-3.verifalia.com/v2.3",
}

// BaseCcaUrls contain the client-certificate authentication base URLs for the Verifalia API.
var BaseCcaUrls = []string{
	"https://api-cca-1.verifalia.com/v2.3",
	"https://api-cca-2.verifalia.com/v2.3",
	"https://api-cca-3.verifalia.com/v2.3",
}
